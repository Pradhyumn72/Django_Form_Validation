...
urlpatterns = [
    ...
    path('login/dashboard/search/byname',views.byname,name='byname'),
    path('login/dashboard/search/byemail',views.byemail,name='byemail'),
    path('login/dashboard/search/byquery',views.byquery,name='byquery'),
